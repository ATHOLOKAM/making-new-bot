    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=message.from_user.id,
                    text="**നിങ്ങൾ ആവിശ്യപ്പെട്ട സിനിമ ലഭിക്കുന്നതിനായി, നിങ്ങൾ താഴെ കൊടുത്തിട്ടുള്ള ചാനലിൽ ജോയിൻ ചെയ്യണം. ജോയിൻ ചെയ്ത ശേഷം വീണ്ടും ബൊട്ടിൽ വന്ന് Restart ബട്ടനിൽ അമർത്തിയാൽ നിങ്ങൾക്ക് സിനിമ ലഭിക്കുന്നതാണ്...🙃!**",
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🔰DEVOLPERS🔰', url="http://t.me/movietym4")
                    ]
                    ]
